...
_HPO_N_ENVS          = 4         # fewer workers → less SubprocVecEnv IPC overhead
...
class TrialEvalCallback(EvalCallback):
    ...
    """
    def __init__(self, eval_env, trial, n_eval_episodes=5, eval_freq=10_000, *args, **kwargs):
        super().__init__(
            eval_env,
...
def optimize(n_trials: int = 50):
    ...
    print(f"  Envs/trial    : {_HPO_N_ENVS}  (vs {TrainConfig().n_envs} in full training)")
